...
const AVAILABLE_ACTIONS = [
  ...
  { id: "project:settings", name: "Cấu hình dự án", desc: "Sửa Volume, Slack Webhook, Restart Policy" },
  { id: "domain:manage", name: "Quản lý tên miền", desc: "Thêm/Sửa/Xóa tên miền riêng (Custom Domain)" },
  ...
  { id: "logs:read", name: "Đọc Log hệ thống", desc: "Xem chi tiết nhật ký lỗi (Logs) và Build log" },
